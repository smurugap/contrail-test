...
class ContrailInstanceIp(contrail.ContrailResource):
    ...
    def handle_create(self):
        ...
        try:
            ...
            raise Exception(_('instance-ip %s could not be created.') % self.name)
