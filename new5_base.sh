...
ulimit -n 65535
python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.ntt.yaml --create --tenant_count 10 --tenant_index_range 500:510
while true;
do
 python diagnostics/systemtest.full.py --ini_file diagnostics/global_params.ini --yaml_config_file diagnostics/symantec.ntt.yaml --traffic_only --tenant_index_range 500:510  --tenant_count 10
sleep 10
done
exit
