...
class Test(object):
    ...
    def get_vm_info(self):
        ...
        svc_obj = ServiceTemplateConfig(None)
        print svc_obj.retrieve_sc_info(conn_obj_list=conn_obj_list,tenant_name_list=tenant_name_list)
        #return vm_info
    ...
    def parse_config(self):
        ...
        for i in xrange(len(tenant_network_conf)):
            ...
            vn_info['ipv4_cidr']       = tenant_network_conf[i].get('ipv4_cidr',None)
            vn_info['ipv6_cidr']       = tenant_network_conf[i].get('ipv6_cidr',None)
    ...
    def configure_tenant(self):
        ...
        #lbaas_obj.create_lb_vips_assocaite_fips(*func_arg)
        #return
        #vm_obj = VM(None)
        #vm_obj.create_vms(*func_arg)
        #return
...
def main():
   ...
   for test_conf in tests:
      ...
      if args.traffic_only or args.stop_traffic:
           args.delete = False
